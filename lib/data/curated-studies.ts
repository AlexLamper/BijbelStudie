...
export const curatedStudies: CuratedStudy[] = [
  ...
  },
  {
    ...
    lessons: [
      { day: 1,  title: 'Aan het hof van Babel',        book: 'Daniël', chapter: 1,  verseRange: '1-21', focus: 'Waarom weigerde Daniël de spijzen van de koning? Waar trok hij zijn grens?', estimatedMinutes: 14 },
      { day: 2,  title: 'De droom van het beeld',        book: 'Daniël', chapter: 2,  verseRange: '1-49', focus: 'Waar staan de vier delen van het beeld voor? Wat is de steen die het beeld verbrijzelt?', estimatedMinutes: 18 },
      { day: 3,  title: 'De vurige oven',                book: 'Daniël', chapter: 3,  verseRange: '1-30', focus: '"En zo niet" - wat zeiden de drie vrienden over God, ook zonder redding?', estimatedMinutes: 15 },
      { day: 4,  title: 'De vernedering van Nebukadnezar', book: 'Daniël', chapter: 4, verseRange: '1-37', focus: 'Wat moest de koning leren? Hoe eindigt zijn eigen verslag?', estimatedMinutes: 15 },
      { day: 5,  title: 'Het schrift aan de wand',       book: 'Daniël', chapter: 5,  verseRange: '1-31', focus: 'Wat betekenen Mene, Tekel en Peres? Waarom trof dit oordeel Belsazar?', estimatedMinutes: 14 },
      { day: 6,  title: 'In de leeuwenkuil',             book: 'Daniël', chapter: 6,  verseRange: '1-28', focus: 'Waarom bleef Daniël driemaal per dag bidden, terwijl hij wist wat het kostte?', estimatedMinutes: 14 },
      { day: 7,  title: 'De vier dieren',                book: 'Daniël', chapter: 7,  verseRange: '1-28', focus: 'Wie is de Zoon des mensen in dit visioen? Welk koninkrijk blijft staan?', estimatedMinutes: 18 },
      { day: 8,  title: 'De ram en de bok',              book: 'Daniël', chapter: 8,  verseRange: '1-27', focus: 'Welke rijken worden hier bij name genoemd? Wat deed het visioen met Daniël?', estimatedMinutes: 16 },
      { day: 9,  title: 'Het gebed van Daniël',          book: 'Daniël', chapter: 9,  verseRange: '1-27', focus: 'Hoe belijdt Daniël de zonde van zijn volk? Waarom zegt hij steeds "wij"?', estimatedMinutes: 18 },
      { day: 10, title: 'De man aan de rivier',          book: 'Daniël', chapter: 10, verseRange: '1-21', focus: 'Wat gebeurde er achter de schermen tijdens die drie weken van gebed?', estimatedMinutes: 14 },
      { day: 11, title: 'Koningen van noord en zuid',    book: 'Daniël', chapter: 11, verseRange: '1-45', focus: 'Wat zegt dit hoofdstuk over hoe nauwkeurig God de geschiedenis kent?', estimatedMinutes: 20 },
      { day: 12, title: 'Het einde en de opstanding',    book: 'Daniël', chapter: 12, verseRange: '1-13', focus: 'Wat wordt er beloofd aan wie ontwaken? Wat moest Daniël verzegelen?', estimatedMinutes: 14 },
    ],
  },
]
