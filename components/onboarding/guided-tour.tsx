...
const STEPS: TourStep[] = [
  ...
  // nothing to point at. Restore both together.
  {
    ...
    description: "KingComments lees je gratis. Pro voegt Matthew Henry, Calvijn en Dachsel toe, plus de volledige grondtekst. Het gratis plan blijft altijd beschikbaar.",
    page: "/lezen",
    side: "right",
  },
  {
