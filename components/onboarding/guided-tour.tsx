...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: "Hiernaast staan de commentaren, de grondtekst, historische context, je notities en de AI-assistent - alles bij het hoofdstuk dat je leest.",
    page: "/lezen",
    side: "left",
  },
  {
    ...
    description: "Elke studie loopt in vijf stappen: intro, het bijbelgedeelte, verdieping, een reflectievraag en een korte quiz. Je voortgang wordt onthouden.",
    page: "/lezen",
    side: "right",
  },
  {
  ...
  // nothing to point at. Restore both together.
  {
    ...
    description: "KingComments lees je gratis. Pro voegt Matthew Henry, Calvijn, Dachsel en Meyer toe, plus de volledige grondtekst. Het gratis plan blijft altijd beschikbaar.",
    page: "/lezen",
    side: "right",
  },
  {
