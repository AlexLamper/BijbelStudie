...
const ProgressOverviewOld = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="shadow-[0_2px_8px_-2px_rgba(0,0,0,0.1),0_4px_16px_-4px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_12px_-2px_rgba(0,0,0,0.15),0_8px_24px_-4px_rgba(0,0,0,0.1)] transition-shadow duration-300 border-border dark:bg-[#23263a]">
