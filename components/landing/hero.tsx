...
/** Apple's mark. Inlined rather than an <img>: it is two paths and must stay crisp. */
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-64px)] py-16 lg:py-24">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/inloggen" data-track="hero_cta_signup">
              ...
              {/* Apple's own black pill rather than an outline button: this is the
                  shape people recognise as "this app is really in the store". */}
              <a
                href={APP_STORE_URL}
                target="_blank"
                ...
                className="group inline-flex items-center justify-center gap-3 rounded-md bg-black px-6 py-[13px] text-white no-underline transition-transform hover:scale-[1.02] dark:bg-white dark:text-black"
              >
                <AppleLogo className="h-7 w-7 flex-none" />
              ...
              <Link href="#about" data-track="hero_cta_learn_more">
