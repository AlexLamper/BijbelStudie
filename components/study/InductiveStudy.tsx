...
export default function InductiveStudy({ book, chapter, preferences }: InductiveStudyProps) {
  ...
  return (
    <Card className="border-0 shadow-none rounded-lg dark:bg-card">
      <CardHeader>
        ...
        <p className={`text-gray-600 dark:text-muted-foreground ${prefClasses}`} style={prefStyles}>
      ...
      <CardContent className="p-6 pt-0 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Textarea
            ...
            className={`min-h-[120px] border border-gray-300 dark:border-border focus:border-[#0D9488] dark:bg-background rounded-lg ${prefClasses}`}
          />
        </div>
