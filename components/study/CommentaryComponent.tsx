            ...
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
              ...
              <div className="max-w-md space-y-2">
                ...
                <p className="text-muted-foreground text-sm">
                  Matthew Henry, Johannes Calvijn en Karl August Dachsel horen bij Pro. KingComments blijft voor iedereen gratis.
                </p>
              </div>
              <UpgradePrompt
                surface="commentary"
                title="Pro-commentaar"
                body="Matthew Henry, Calvijn en Dachsel zijn onderdeel van Pro. KingComments leest u gratis, volledig."
